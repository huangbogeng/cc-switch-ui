...
import { getOAuthStatus, startOAuth, pollOAuth, getProxyStatus, startProxy, stopProxy } from '../api';
...
const styles: Record<string, React.CSSProperties> = {
  ...
  buttonSecondary: { padding: '10px 20px', background: 'transparent', border: '1px solid #0f3460', borderRadius: '6px', cursor: 'pointer', color: '#888', marginTop: '15px' },
};
